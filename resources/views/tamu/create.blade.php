    ...
    <div class="register-box">
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <h4 class="justify-content-center">Daftar Tamu</h4>

                <form method="POST" action="{{ route('tamu.store') }}">
                    @csrf

                    <div class="input-group mb-3 mt-3">
                        <input id="nama" type="text" class="form-control" placeholder="Nama Lengkap" name="nama" required
                    ...
                    <div class="input-group mb-3">
                        <input id="instansi" type="text" class="form-control" placeholder="Instansi" name="instansi"
                    ...
                    <div class="input-group mb-3">
                        <input id="jabatan" type="text" class="form-control" placeholder="Jabatan" name="jabatan"
                    ...
                    <div class="input-group mb-3">
                        <input id="no_telp" type="text" class="form-control" placeholder="Nomor Handphone"
